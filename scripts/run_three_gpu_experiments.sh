...
echo "  outputs/checkpoints/qwen3-1.7b-jobmatch-lr1e-4-r8"
echo "  outputs/checkpoints/qwen3-1.7b-jobmatch-lr2e-4-r8"
echo "  outputs/checkpoints/qwen3-1.7b-jobmatch-lr1e-4-r16"
