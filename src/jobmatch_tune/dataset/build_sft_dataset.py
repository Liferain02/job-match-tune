...
STRICT_DIRECTION_TITLE_HINTS = {
    ...
    "后端开发": ["olap", "控制面", "中间件", "引擎", "数据库", "dba", "分布式存储", "服务器开发", "后台团队负责人", "操作系统", "编译优化"],
    ...
    "运维开发": ["gpu资源", "指挥中心", "可靠性", "devops", "sre", "infra", "运营开发"],
    "客户端开发": ["app", "ios", "android", "unity", "ue", "u3d", "sdk", "游戏客户端", "音视频引擎"],
