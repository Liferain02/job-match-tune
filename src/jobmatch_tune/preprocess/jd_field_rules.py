...
TITLE_PRIORITY_PATTERNS = [
    ...
    ("客户端开发", [r"客户端开发", r"ios开发", r"android开发", r"移动端开发", r"unity开发", r"u3d开发", r"ue开发", r"cocos", r"软件开发工程师\s*\(sdk\)"]),
    ...
    ("后端开发", [r"后台开发", r"后端开发", r"服务端", r"后台工程师", r"研发岗", r"资深架构师岗", r"软件架构开发工程", r"服务器开发工程师", r"服务器高级工程师", r"操作系统高级研发工程师", r"linux内核高级研发工程师"]),
...
def infer_job_direction(title: str, text: str, schema: dict[str, Any]) -> str:
    ...
    title_rules = [
        ...
        ("客户端开发", ["客户端", "ios", "android", "unity", "u3d", "ue", "cocos", "sdk", "游戏客户端", "音视频引擎"]),
        ...
        ("后端开发", ["后台", "后端", "服务端", "全栈", "引擎", "存储", "框架研发", "平台研发", "dba", "数据库", "研发岗", "架构师岗", "软件架构开发", "服务器开发", "操作系统研发", "linux内核"]),
