...
JOB_DIRECTION_RULES = [
    ...
    ("汽车软件/智驾研发", ["智驾系统", "驾驶辅助", "泊车功能", "智能行车系统", "车控软件", "整车控制软件", "智驾软件集成", "底盘集成控制系统", "底盘电控功能开发", "感知质量开发"]),
...
TITLE_PRIORITY_PATTERNS = [
    ...
    ("网络与基础设施", [r"网络规划", r"网络开发", r"网络工程师", r"网络交付", r"基础架构工程师", r"数据中心网络"]),
    ("AI Infra", [r"ai infra", r"ai infrastructure", r"机器学习平台", r"训练平台", r"推理平台", r"训推平台", r"rl infra"]),
    ("高性能计算", [r"高性能计算", r"\bhpc\b"]),
    ("汽车软件/智驾研发", [r"智驾系统架构工程师", r"驾驶辅助开发工程师", r"智能行车系统开发工程师", r"智驾泊车功能开发工程师", r"底盘集成控制系统开发", r"底盘电控功能开发工程师", r"感知质量开发工程师"]),
    ("运维开发", [r"\bsre\b", r"运维开发", r"devops", r"平台运维", r"\bidc\b", r"网络交付工程师", r"网络工程师", r"运营运维工程师", r"秒送物流sre"]),
    ...
    ("后端开发", [r"后台开发", r"后端开发", r"服务端", r"后台工程师", r"研发岗", r"资深架构师岗", r"软件架构开发工程"]),
